...
<script>
    ...
    export default {
                ...
                section2: [
                    {
                        ...
                        nowPrice: '5.4',
                        oldPrice: '6',
                        url: 'https://p0.meituan.net/deal/1622253d14a4c4d8e839768e87b39a457091.jpg.webp@120w_90h_1e_1c_1l%7Cwatermark=1&&r=1&p=9&x=20&y=20'
                    },
                    {
                        title: '百果园',
                        nowPrice: '6.9',
                        oldPrice: '10.0',
                        url: 'https://p0.meituan.net/deal/c355cefa52a206133b474b524cd7df0f18936.jpg.webp@120w_90h_1e_1c_1l%7Cwatermark=1&&r=1&p=9&x=20&y=20'
                    },
                    {
                        title: '百果园',
                        nowPrice: '8.9',
                        oldPrice: '13.8',
                        url: 'https://p0.meituan.net/deal/5cebb9b7bdc04c6e29e7ddd61386204d18280.jpg.webp@120w_90h_1e_1c_1l%7Cwatermark=1&&r=1&p=9&x=20&y=20'
                    }
                ],
            }
        },
        ...
        methods: {
            load: function () {
                this.$axios.get('https://www.easy-mock.com/mock/5cfdc08102fa400c0876ef52/jousen/DZDPlist')
                    .then(res=>{
            ...
            GetData: function () {
                let T1 = () => {
                    return this.$axios.get('https://www.easy-mock.com/mock/5cfdc08102fa400c0876ef52/jousen/DZDPlist')
                };
                let T2 = () => {
                    return this.$axios.get('https://www.easy-mock.com/mock/5cfdc08102fa400c0876ef52/jousen/CatEyesnav')
                };
               this.$axios.all([T1(), T2()])
                    .then(this.$axios.spread((t1,t2)=> {
                        this.ListData = [...this.ListData, ...t1.data.data]
                        this.nav.push(t2.data.data.slice(0, 10))
                        this.nav.push(t2.data.data.slice(10, 20))
                    }))
            },
